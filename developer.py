...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Shubhangi\Documents\Python_Test_Projects\Images_GUI\bg4.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Shubhangi\Documents\Python_Test_Projects\Images_GUI\IMG-20230325-WA0001.jpg")
        ...
        std_b1_1 = Button(bg_img,text="M.Pallavi",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Student  button 2
        det_img_btn=Image.open(r"C:\Users\Shubhangi\Documents\Python_Test_Projects\Images_GUI\IMG-20221019-WA0000.jpg")
        ...
        det_b1_1 = Button(bg_img,text="K.Shubhangi",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        #att_img_btn=Image.open(r"C:\Users\Shubhangi\Documents\Python_Test_Projects\Images_GUI\w.jpg")
        ...
        #hlp_img_btn=Image.open(r"C:\Users\Shubhangi\Documents\Python_Test_Projects\Images_GUI\m1.png")
