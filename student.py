...
# Testing Connection 
"""
conn = mysql.connector.connect(username='root', password='#Shubhi16',host='localhost',database='face_recognition',port=3306)
cursor = conn.cursor()
...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CS","IT","Ani","Ele")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","MCS","MIT","MCA","MAni","MTech")
        cou_combo.current(0)
        ...
        div_combo["values"]=("Select","Batch-1","Batch-2")
        div_combo.current(0)
        ...
        search_combo["values"]=("Select","Roll-No","Course","Department","Year","Semester")
